                    ...
                    <ul class="navbar-nav align-items-center  ml-md-auto ">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-xl  dropdown-menu-right  py-0 overflow-hidden">
                                <!-- Dropdown header -->
                                <div class="px-3 py-3">
                                    <h6 class="text-sm text-muted m-0">You have <strong class="text-green">13</strong> notifications.</h6>
                                </div>
                                <!-- List group -->
                                    ...
                                    <a href="#!" class="list-group-item list-group-item-action">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col ml--2">
                                                ...
                                                <p class="text-sm mb-0">A new issue has been reported for Bujo.</p>
                                            </div>
                                        </div>
                                    </a>
                                    <a href="#!" class="list-group-item list-group-item-action">
                                ...
                                <!-- View all -->
                                <a href="#!" class="dropdown-item text-center text-green font-weight-bold py-3">View all</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-dark bg-white dropdown-menu-right">
                                <div class="row shortcuts px-4">
                                    <a href="#!" class="col-4 shortcut-item my-2 text-center">
                                        <span class="shortcut-media avatar rounded-circle bg-gradient-red">
                                            <i class="ni ni-calendar-grid-58"></i>
                                        </span>
                                        <small class="text-dark">Calendar</small>
                                    </a>
                                    <a href="#!" class="col-4 shortcut-item my-2 text-center">
                                    ...
                                    <a href="#!" class="col-4 shortcut-item my-2 text-center">
                                        ...
                                        <small class="text-dark">Reports</small>
                                    </a>
                                    <a href="#!" class="col-4 shortcut-item my-2 text-center">
                                        <span class="shortcut-media avatar rounded-circle bg-gradient-purple">
                                            <i class="ni ni-pin-3"></i>
                                        </span>
                                        <small class="text-dark">Maps</small>
                                    </a>
                                    <a href="#!" class="col-4 shortcut-item my-2 text-center">
            ...
            <div class="row align-items-center justify-content-lg-between">
                <div class="col-lg-6">
                    <div class="copyright text-center  text-lg-left  text-muted">
                        &copy; 2022 <a href="#" class="font-weight-bold ml-1 text-green" target="_blank">Bujo</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                        <li class="nav-item">
                            <a href="#" class="nav-link" target="_blank">Bujo</a>
                        </li>
                        <li class="nav-item">
