                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 text-white d-inline-block mb-0">Activity Tracker</h6>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="table-responsive">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input v-model="entry.activity" type="text" class="form-control" placeholder="Activity" name="activity" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="time">Time</label>
                                                <input v-model="entry.time" type="time" class="form-control" placeholder="Time" name="time" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <ActivityLogEntries v-on:updateEntry="editEntry" v-on:updateLogs="getEntries()" :entries="logEntries" />
                        </div>
                        <!-- Card footer -->
...
<script>
import ActivityLogEntries from '../components/ActivityLogEntries.vue';
    ...
    methods: {
        ...
        submitEntry() {
            if (this.entry.activity == "" ||
                ...
                this.error = [];
                axios.post('api/activitylog/store', {
                    activitylog: this.entry,
                })
                .then(response => {
        ...
        editEntry(id) {
            ...
            this.logEntries.forEach(entry => {
                if (entry.id == id) {
                    this.entry.activity = entry.activity;
        ...
        updateEntry() {
            axios.put('api/activitylog/' + this.editMode, {
                activitylog: this.entry,
            })
            .then(response => {
